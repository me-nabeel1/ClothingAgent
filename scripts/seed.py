...
async def seed_db(db: AsyncSession):
    ...
    cat_config = {
        "Shirts": {
            "types": ["shirt", "oxford_shirt", "dress_shirt", "linen_shirt"],
            "occasions": ["formal", "casual", "business"],
            "materials": ["Cotton", "Linen", "Silk", "Poly-Blend"],
            "fits": ["Slim", "Regular", "Relaxed"],
            "names": ["Oxford Shirt", "Linen Shirt", "Dress Shirt", "Button-Down Shirt"],
            ...
            "images": [
                ...
                "https://images.pexels.com/photos/769745/pexels-photo-769745.jpeg?auto=compress&cs=tinysrgb&w=800",
                "https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?auto=compress&cs=tinysrgb&w=800",
            ],
        },
        "T-Shirts": {
            "types": ["t_shirt", "crew_neck", "v_neck"],
            "occasions": ["casual", "daily"],
            "materials": ["Cotton", "Polyester", "Jersey"],
            "fits": ["Regular", "Slim", "Oversized"],
            "names": ["Crew Neck T-Shirt", "V-Neck T-Shirt", "Graphic Tee", "Plain Cotton Tee"],
            "prefixes": ["Basic", "Premium", "Streetwear", "Vintage", "Essential"],
            ...
            "images": [
                ...
                "https://images.pexels.com/photos/1232459/pexels-photo-1232459.jpeg?auto=compress&cs=tinysrgb&w=800",
        ...
        "Pants": {
            ...
            "materials": ["Cotton Blend", "Poly-Viscose", "Linen"],
            "fits": ["Slim", "Straight", "Tailored"],
            "names": ["Cotton Chinos", "Khaki Pants", "Flat Front Pants", "Stretch Chinos"],
            "prefixes": ["Everyday", "Formal", "Classic", "Stretch", "Premium"],
            "price_range": (2500, 6500),
            "size_range": ["30", "32", "34", "36", "38"],
            "images": [
        ...
        "Traditional": {
            "types": ["kurta", "shalwar_kameez", "waistcoat"],
            "occasions": ["wedding", "eid", "festive"],
            "materials": ["Cotton", "Silk Blend", "Brocade", "Wash-n-Wear"],
            "fits": ["Regular", "Tailored"],
            "names": ["Cotton Kurta", "Shalwar Kameez", "Ethnic Waistcoat", "Festive Kurta"],
        ...
        "Outerwear": {
            "types": ["jacket", "bomber_jacket", "leather_jacket", "hoodie"],
            "occasions": ["casual", "party", "winter"],
            "materials": ["Polyester", "Leather", "Fleece", "Wool"],
            "fits": ["Regular", "Slim", "Relaxed"],
            "names": ["Bomber Jacket", "Leather Moto Jacket", "Winter Fleece Hoodie", "Puffer Jacket"],
        ...
        "Formal Wear": {
            "types": ["suit", "blazer", "tuxedo"],
            "occasions": ["business", "wedding", "formal"],
            "materials": ["Wool Blend", "Poly-Viscose", "Italian Wool"],
            "fits": ["Tailored", "Slim", "Classic"],
            "names": ["Two-Piece Formal Suit", "Executive Navy Blazer", "Three-Piece Suit", "Black Tuxedo"],
        ...
        "Jeans": {
            ...
            "fits": ["Skinny", "Slim", "Straight", "Bootcut"],
            "names": ["Blue Denim Jeans", "Black Jeans", "Faded Jeans", "Straight Cut Jeans"],
        ...
        "Activewear": {
            "types": ["shorts", "joggers", "tracksuit"],
            "occasions": ["gym", "casual", "running"],
            "materials": ["Polyester Blend", "Fleece", "Spandex"],
            "fits": ["Regular", "Slim", "Athletic"],
            "names": ["Running Shorts", "Fleece Joggers", "Tapered Track Pants", "Tracksuit"],
        ...
        "Gym Wear": {
            "types": ["compression_tee", "tank_top", "workout_tee"],
            "occasions": ["gym", "workout", "running"],
            "materials": ["Spandex", "Mesh", "Moisture-wicking Polyester"],
            "fits": ["Tight", "Athletic", "Regular"],
            "names": ["Compression Workout Tee", "Athletic Tank Top", "Performance Gym Shirt"],
        ...
        "Trousers": {
            "types": ["trousers", "dress_trousers"],
            "occasions": ["casual", "business", "formal"],
            "materials": ["Cotton", "Twill", "Poly-Viscose"],
            "fits": ["Relaxed", "Straight", "Slim"],
            "names": ["Executive Pleated Trousers", "Smart Dress Trousers", "Tailored Trousers"],
            "prefixes": ["Casual", "Classic", "Formal", "Premium", "Everyday"],
