...
from sqlalchemy import Integer, ForeignKey, DateTime, UniqueConstraint, Index, CheckConstraint
...
class BranchInventory(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("in_transit_quantity >= 0", name="in_transit_quantity_non_negative"),
        CheckConstraint("quantity_on_hand >= reserved_quantity + damaged_quantity", name="valid_available_quantity"),
        {"schema": SCHEMA},
    )
