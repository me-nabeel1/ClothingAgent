...
from sqlalchemy import Integer, String, DateTime, ForeignKey, UniqueConstraint, func, Uuid
...
class Cart(Base):
    ...
    store_id: Mapped[str] = mapped_column(String(50), nullable=False, default="northstar")
