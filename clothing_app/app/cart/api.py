...
async def create_cart(
    body: CreateCartRequest | None = None,
    service: CartService = Depends(get_cart_service),
) -> CartView:
    """Reuse or create a cart for the caller session without breaking empty-body clients."""
    body = body or CreateCartRequest()
    return await service.create(body.session_id, body.store_id)
