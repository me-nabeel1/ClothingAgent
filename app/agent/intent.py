...
class IntentExtractor:
    ...
    async def extract(
        ...
        system_instruction = (
            ...
            "Rules:\n"
            "1. General Store Offering & Discount Queries (CRITICAL): If the user asks general questions like 'what do you have?', 'what products do you offer?', 'what categories do you sell?', 'store offerings', 'tell me about your store', or 'do you have discounts?', intent MUST be 'general_chat'. NEVER classify broad general inquiry questions as 'search'!\n"
